...
public class DaoCliente {
    ...
    public static String insert(BeanCliente bp) {
        String sql = "INSERT INTO bdcmsa.cliente (cod_cliente, razon_social, " +
                "ruc, direccion, zona, giro, tipo_cuenta,estado) VALUES ('"+bp.getCodigo()+"',"
                + "'"+bp.getRazon_Social()+"', "
                + "'"+bp.getRuc()+"', "
                + "'"+bp.getDireccion()+"', "
                + "'"+bp.getZona()+"', "
    ...
    public static String update(BeanCliente bp) {
       String sql = "UPDATE bdcmsa.cliente SET " +
